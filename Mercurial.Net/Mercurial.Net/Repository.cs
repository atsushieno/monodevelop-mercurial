...
namespace Mercurial
{
    ...
    public sealed class Repository : IDisposable
    {
        ...
        /// </summary>
        /// <param name="command">
        /// Any extra options to the graft method.
        /// </param>
        public void Graft(GraftCommand command)
        {
            if (command == null)
                throw new ArgumentNullException("command");
        ...
        /// </summary>
        /// <param name="revision">
        /// The <see cref="RevSpec"/> of the changeset(s) to graft unto the current branch.
        /// </param>
        /// <param name="command">
        /// Any extra options to the graft method, or <c>null</c> for default options.
        /// </param>
        public void Graft(RevSpec revision, GraftCommand command = null)
        {
            if (revision == null)
                throw new ArgumentNullException("revision");
            if (command != null && command.Revision != null)
                throw new ArgumentException("GraftCommand.Revision cannot be set before calling this method", "command");

            command = (command ?? new GraftCommand())
        ...
        /// <summary>
        /// Sets or shows the current phase.
        /// </summary>
        /// <param name="command">
        /// The options to the phase method.
        /// </param>
        /// <returns>
        /// A collection of <see cref="ChangesetPhase"/> objects, specifying the phase of each changeset queried;
        /// or an empty collection of the command was used to set the phase.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="command"/> is <c>null</c>.
        /// </exception>
        public IEnumerable<ChangesetPhase> Phase(PhaseCommand command)
        {
            if (command == null)
                throw new ArgumentNullException("command");
        ...
        /// </summary>
        /// <param name="revision">
        /// The revision(s) of the changesets to set or show the phase of.
        /// </param>
        /// <param name="command">
        /// Any extra options to the phase method, or <c>null</c> for default options.
        /// </param>
        /// <returns>
        /// A collection of <see cref="ChangesetPhase"/> objects, specifying the phase of each changeset queried;
        /// or an empty collection of the command was used to set the phase.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="revision"/> is <c>null</c>.
        /// </exception>
        public IEnumerable<ChangesetPhase> Phase(RevSpec revision, PhaseCommand command = null)
        {
            if (revision == null)
                throw new ArgumentNullException("revision");

            command = (command ?? new PhaseCommand())
                .WithRevisions(revision);
