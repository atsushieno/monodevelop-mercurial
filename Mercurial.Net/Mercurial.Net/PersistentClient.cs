    ...
    public sealed class PersistentClient : IClient, IDisposable
    {
        ...
        private void StartPersistentMercurialClient()
        {
            var psi = new ProcessStartInfo
            {
                ...
                ErrorDialog = false,
                Arguments = "serve --cmdserver pipe --noninteractive --encoding " + ClientExecutable.TextEncodingName,
            };
            var encoding = ClientExecutable.TextEncoding;
            psi.EnvironmentVariables ["LANGUAGE"] = "EN";
            psi.EnvironmentVariables ["HGENCODING"] = ClientExecutable.TextEncodingName;
