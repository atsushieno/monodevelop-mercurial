...
namespace Mercurial
{
    ...
    public sealed class Annotation : IEquatable<Annotation>
    {
		...
		/// <summary>
		/// This is the backing field for the <see cref="Date"/> property.
		/// </summary>
        ...
        /// </exception>
        public Annotation(int lineNumber, int revisionNumber, string line, string user, DateTimeOffset date)
        {
		...
		/// <summary>
		/// Gets the date of the change of that line.
		/// </summary>
		...
		/// <summary>
		/// Gets the user of the change of that line.
		/// </summary>
		public string User
		{
			get
