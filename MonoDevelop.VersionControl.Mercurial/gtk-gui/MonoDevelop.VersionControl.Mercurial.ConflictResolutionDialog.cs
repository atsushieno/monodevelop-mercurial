...
namespace MonoDevelop.VersionControl.Mercurial
{
	internal partial class ConflictResolutionDialog
	{
		...
		private global::Gtk.Button button287;
		
		protected virtual void Build ()
		{
			global::Stetic.Gui.Initialize (this);
			// Widget MonoDevelop.VersionControl.Mercurial.ConflictResolutionDialog
			this.Name = "MonoDevelop.VersionControl.Mercurial.ConflictResolutionDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.VersionControl.Mercurial.ConflictResolutionDialog.VBox
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child MonoDevelop.VersionControl.Mercurial.ConflictResolutionDialog.ActionArea
			...
			w7.Fill = false;
			// Container child dialog1_ActionArea.Gtk.ButtonBox+ButtonBoxChild
			this.button287 = new global::Gtk.Button ();
			this.button287.CanFocus = true;
			this.button287.Name = "button287";
			this.button287.UseUnderline = true;
			this.button287.Label = global::Mono.Unix.Catalog.GetString ("Accept Merge");
			this.AddActionWidget (this.button287, 0);
			global::Gtk.ButtonBox.ButtonBoxChild w8 = ((global::Gtk.ButtonBox.ButtonBoxChild)(w5 [this.button287]));
			w8.Position = 2;
			w8.Expand = false;
			w8.Fill = false;
			if ((this.Child != null)) {
