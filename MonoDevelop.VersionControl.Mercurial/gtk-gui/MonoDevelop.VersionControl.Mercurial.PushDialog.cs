...
namespace MonoDevelop.VersionControl.Mercurial
{
	public partial class PushDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.VersionControl.Mercurial.PushDialog
			this.Name = "MonoDevelop.VersionControl.Mercurial.PushDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Push to Repository");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.VersionControl.Mercurial.PushDialog.VBox
			...
			w8.Position = 0;
			// Internal child MonoDevelop.VersionControl.Mercurial.PushDialog.ActionArea
