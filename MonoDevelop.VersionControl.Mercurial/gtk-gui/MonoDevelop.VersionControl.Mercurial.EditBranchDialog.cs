...
namespace MonoDevelop.VersionControl.Mercurial
{
	public partial class EditBranchDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.VersionControl.Mercurial.EditBranchDialog
			this.Name = "MonoDevelop.VersionControl.Mercurial.EditBranchDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Branch Properties");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.VersionControl.Mercurial.EditBranchDialog.VBox
			...
			w9.Expand = false;
			w9.Fill = false;
			// Internal child MonoDevelop.VersionControl.Mercurial.EditBranchDialog.ActionArea
			...
			this.checkTrack.Hide ();
			this.comboSources.Hide ();
			this.Show ();
