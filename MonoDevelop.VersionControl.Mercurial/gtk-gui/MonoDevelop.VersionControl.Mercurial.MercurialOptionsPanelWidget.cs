...
{
	public partial class MercurialOptionsPanelWidget
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.VersionControl.Mercurial.MercurialOptionsPanelWidget
			global::Stetic.BinContainer.Attach (this);
			this.Name = "MonoDevelop.VersionControl.Mercurial.MercurialOptionsPanelWidget";
			// Container child MonoDevelop.VersionControl.Mercurial.MercurialOptionsPanelWidget.Gtk.Container+ContainerChild
			...
			this.checkStashBranch.Hide ();
			this.checkStashUpdate.Hide ();
			this.Hide ();
		}
	}
}
