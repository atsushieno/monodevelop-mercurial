...
namespace MonoDevelop.VersionControl.Mercurial
{
	public partial class MergeDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.VersionControl.Mercurial.MergeDialog
			this.Name = "MonoDevelop.VersionControl.Mercurial.MergeDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.VersionControl.Mercurial.MergeDialog.VBox
			...
			w7.Position = 0;
			// Internal child MonoDevelop.VersionControl.Mercurial.MergeDialog.ActionArea
